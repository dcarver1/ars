...
The importance of this collection is increased by the fact that many of the seed taxa that were collected do the SOS program are defined as either Wild Crop Relatives or World Economic Plants. We will use two datasets that have defined economically useful plants, Khoury et al 2013, and *get reference for the WEP dataset received from Daniel*. 
...
sosAccessions <- read.csv("H:\\SOS_Project\\analysisData\\sosAccessions.csv")
...
```{r}
#call in sosAccessions: summarize by is backed up or backup location 
