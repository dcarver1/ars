...
colnames(families) <- c("Genera", "Total Number of Accessions")
genera1
...
The table below illustrates the total number of genera and taxa listed in the datasets. The SOS, K13, and WEP data sets reference plants found in the USA.
```{r echo=FALSE, tidy=TRUE, message=FALSE, warning=FALSE}
...
#define column names and row names
colnames(dataSummary) <- c(  "Total Number of Genera", "Total Number of Species")
...
The following table displays the number and proportion of SOS accessions that could be classified by Khoury et al. 2013 as CWR and/or WUS, or by Wiersema and Leon 2013 as a WEP.**CK - list CWR then WUS then WEP, always in that order. Also I think this table would be better horizontal rather than vertical**
